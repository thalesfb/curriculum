...
describe('build output validation', () => {
  ...
  it.skipIf(!hasBuild)('pages contain hreflang tags', () => {
    const html = readFileSync(resolve(distDir, 'pt/index.html'), 'utf-8');
  ...
  it.skipIf(!hasBuild)('sitemap was generated', () => {
